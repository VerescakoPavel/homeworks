...
public class ReactorAlerts {
    ...
    public static final double AVERAGE_TEMPERATURE_INCREASE_LIMIT_COEF = 1.1; // 10% of average temperature
    ...
    public static void overheatingAlertCheck(double currentTemperature, double previousTemperature, double averageTemperature) {
        ...
        double averageTempPlus10Percent = averageTemperature * AVERAGE_TEMPERATURE_INCREASE_LIMIT_COEF;
